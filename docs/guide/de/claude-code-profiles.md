...
Die Anfrage wird **direkt** an ein einzelnes LLM (z.B. `phi4:14b-fp16`)
...
| `tool_model` | LLM fuer Tool-Ausfuehrung (z.B. `phi4:14b-fp16`) |
...
|--------|-----|-----------|-------------|----------|------------|
| Fast | `cc-innovator-fast` | `phi4:14b-fp16` | 30-90s | aus | 4.096 |
