...
description: "Reviews HTML/CSS for visual hierarchy (size, color, weight, position, density signaling what to look at first) and rhythm (consistent 4px/8px spacing and type scales, repetition with strategic variation). Use when polishing a generated design, checking whether a layout feels intentional vs. flat/chaotic, or when the user asks to fix spacing, type scale, or visual hierarchy."
---

<!--
Imported from https://github.com/Trystan-SA/claude-design-system-prompt (codex/skills/hierarchy-rhythm-review.md)
Copyright (c) 2026 Trystan Sarrade — MIT License. See repository LICENSE for full text.
Imported into MoE-Sovereign 2026-07-05 per AGENT_LASTENHEFT.md TASK-32 (community skill,
audited via services/skills.py admin_approved gate before activation).
-->
...
Run both passes **sequentially** against the file (single agent loop — no subagent dispatch), collecting findings as you go before fixing.
...
Aggregate findings from both passes.
