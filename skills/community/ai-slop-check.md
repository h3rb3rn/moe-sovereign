---
name: "ai-slop-check"
description: "Detects and fixes generic AI-generated design tropes (rainbow gradients, decorative emoji, default SaaS card patterns, silent Inter/Roboto/Arial font defaults, harsh pure-black-on-white color, untraceable inline color values, off-scale spacing) in HTML/CSS output. Use when reviewing or polishing generated UI, before delivering a design artifact, or when the user asks to remove 'AI slop' / make a design look less generic."
---

<!--
Imported from https://github.com/Trystan-SA/claude-design-system-prompt (codex/skills/ai-slop-check.md)
