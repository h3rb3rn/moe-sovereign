...
- **Context:** The IMoE gating network's multi-task head needs training on
  ...
  generated at `/home/philipp/synthetic_router_dataset.json`. The blocker is
...
- **Instructions:**
  ...
  3. Once the cert is valid (verify with `ssh lumi.csc.fi true` or
     ...
     `scp /home/philipp/synthetic_router_dataset.json lumi:/scratch/project_465003058/hornphil/data/`
