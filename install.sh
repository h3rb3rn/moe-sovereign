...
mkdir -p \
  ...
  /opt/moe-infra/neo4j-logs \
  /opt/moe-infra/agent-logs \
  /opt/moe-infra/chroma-onnx-cache \
  /opt/moe-infra/chroma-data \
  /opt/moe-infra/redis-data \
  /opt/moe-infra/prometheus-data \
  /opt/moe-infra/admin-logs \
  /opt/moe-infra/userdb \
  /opt/moe-infra/few-shot \
  /opt/grafana/data \
